...
export default function Page() {
  return (
    <main className="flex-1 overflow-y-clip overflow-x-scroll snap-mandatory snap-x flex flex-row lg:gap-2 max-w-[100vw] md:min-h-full scroll-bars-none scroll-bars-none-ie">
